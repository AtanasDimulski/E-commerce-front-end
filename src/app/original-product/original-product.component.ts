...
@Component({
  selector: 'app-original-product',
  templateUrl: './original-product.component.html',
  styleUrls: ['./original-product.component.css']
})
export class OriginalProductComponent implements OnInit {
